/* Generated by "click-buildtool elem2export" on Tue Nov  4 15:54:54 CET 2014 */
...
beetlemonkey(uintptr_t heywood)
{
  switch (heywood) {
   ...
   case 110: return new ForeignRequestProcess;
   case 111: return new HomeRequestProcess;
   case 112: return new MobilityEmulator;
   case 113: return new RegistrationRequestSender;
   case 114: return new SimpleIdle;
   case 115: return new SimplePrioSched;
   case 116: return new SimplePullSwitch;
   case 117: return new SimpleRRSched;
   case 118: return new AddressInfo;
   case 119: return new Align;
   case 120: return new AlignmentInfo;
   case 121: return new AnnotationInfo;
   case 122: return new AverageCounter;
   case 123: return new BandwidthMeter;
   case 124: return new BandwidthShaper;
   case 125: return new Block;
   case 126: return new Burster;
   case 127: return new BandwidthRatedSplitter;
   case 128: return new BandwidthRatedUnqueue;
   case 129: return new CheckCRC32;
   case 130: return new CheckLength;
   case 131: return new CheckPaint;
   case 132: return new Classifier;
   case 133: return new ClickyInfo;
   case 134: return new CompareBlock;
   case 135: return new Counter;
   case 136: return new DelayShaper;
   case 137: return new DelayUnqueue;
   case 138: return new DevirtualizeInfo;
   case 139: return new Discard;
   case 140: return new DiscardNoFree;
   case 141: return new DriverManager;
   case 142: return new DropBroadcasts;
   case 143: return new DRRSched;
   case 144: return new ErrorElement;
   case 145: return new FlowInfo;
   case 146: return new FrontDropQueue;
   case 147: return new FullNoteQueue;
   case 148: return new FullNoteQueue;
   case 149: return new HashSwitch;
   case 150: return new Hub;
   case 151: return new Idle;
   case 152: return new InfiniteSource;
   ...
   case 167: return new Null1;
   case 168: return new Null2;
   case 169: return new Null3;
   case 170: return new Paint;
   case 171: return new PaintSwitch;
   case 172: return new PaintTee;
   case 173: return new PortInfo;
   case 174: return new Print;
   case 175: return new PrioSched;
   case 176: return new PullSwitch;
   case 177: return new QuickNoteQueue;
   case 178: return new QuitWatcher;
   case 179: return new RandomBitErrors;
   case 180: return new RandomSample;
   case 181: return new RandomSource;
   case 182: return new RandomSwitch;
   case 183: return new RatedSource;
   case 184: return new RatedSplitter;
   case 185: return new RatedUnqueue;
   case 186: return new RRSched;
   case 187: return new RoundRobinSwitch;
   case 188: return new ScheduleInfo;
   case 189: return new Script;
   case 190: return new SetAnnoByte;
   case 191: return new SetCRC32;
   case 192: return new SetPacketType;
   case 193: return new SetTimestamp;
   case 194: return new Shaper;
   case 195: return new SimpleQueue;
   case 196: return new StaticPullSwitch;
   case 197: return new StaticSwitch;
   case 198: return new StoreData;
   case 199: return new StrideSched;
   case 200: return new StrideSwitch;
   case 201: return new Strip;
   case 202: return new StripToNetworkHeader;
   case 203: return new Suppressor;
   case 204: return new Switch;
   case 205: return new Tee;
   case 206: return new PullTee;
   case 207: return new ThreadSafeQueue;
   case 208: return new TimedSink;
   case 209: return new TimedSource;
   case 210: return new TimedUnqueue;
   case 211: return new Truncate;
   case 212: return new Unqueue;
   case 213: return new Unqueue2;
   case 214: return new Unstrip;
   case 215: return new CheckTCPHeader;
   case 216: return new CheckUDPHeader;
   case 217: return new DynamicUDPIPEncap;
   case 218: return new IPRewriter;
   case 219: return new SetTCPChecksum;
   case 220: return new SetUDPChecksum;
   case 221: return new TCPFragmenter;
   case 222: return new TCPIPSend;
   case 223: return new TCPRewriter;
   case 224: return new UDPIPEncap;
   case 225: return new UDPRewriter;
   case 226: return new BigHashMapTest;
   case 227: return new BigintTest;
   case 228: return new BlockThread;
   case 229: return new CheckPacket;
   case 230: return new CLPTest;
   case 231: return new ComparePackets;
   case 232: return new ConfParseTest;
   case 233: return new CryptoTest;
   case 234: return new ErrorTest;
   case 235: return new FunctionTest;
   case 236: return new HandlerTask;
   case 237: return new HashTableTest;
   case 238: return new HeapTest;
   case 239: return new ListTest;
   case 240: return new NeighborhoodTest;
   case 241: return new NotifierDebug;
   case 242: return new NullTask;
   case 243: return new PacketTest;
   case 244: return new QueueYankTest;
   case 245: return new RandomSeed;
   case 246: return new SchedOrderTest;
   case 247: return new SortTest;
   case 248: return new TimerTest;
   case 249: return new TokenBucketTest;
   case 250: return new UpstreamNotifier;
   case 251: return new VectorTest;
   case 252: return new SpinlockAcquire;
   case 253: return new SpinlockInfo;
   case 254: return new SpinlockRelease;
   case 255: return new StaticThreadSched;
   case 256: return new ChangeUID;
   case 257: return new ChatterSocket;
   case 258: return new ControlSocket;
   case 259: return new FromDevice;
   case 260: return new FromDump;
   case 261: return new FromHost;
   case 262: return new FromRawSocket;
   case 263: return new FromSocket;
   case 264: return new KernelFilter;
   case 265: return new KernelTap;
   case 266: return new KernelTun;
   case 267: return new KernelHandlerProxy;
   case 268: return new ProgressBar;
   case 269: return new RawSocket;
   case 270: return new Socket;
   case 271: return new ToDevice;
   case 272: return new ToDump;
   case 273: return new ToHost;
   case 274: return new ToRawSocket;
   case 275: return new ToSocket;
   case 276: return new UMLSwitch;
   default: return 0;
  }
}
...
click_export_elements()
{
  ...
  (void) click_add_element_type_stable("ForeignRequestProcess", beetlemonkey, 110);
  (void) click_add_element_type_stable("HomeRequestProcess", beetlemonkey, 111);
  (void) click_add_element_type_stable("MobilityEmulator", beetlemonkey, 112);
  (void) click_add_element_type_stable("RegistrationRequestSender", beetlemonkey, 113);
  (void) click_add_element_type_stable("SimpleIdle", beetlemonkey, 114);
  (void) click_add_element_type_stable("SimplePrioSched", beetlemonkey, 115);
  (void) click_add_element_type_stable("SimplePullSwitch", beetlemonkey, 116);
  (void) click_add_element_type_stable("SimpleRoundRobinSched", beetlemonkey, 117);
  (void) click_add_element_type_stable("AddressInfo", beetlemonkey, 118);
  (void) click_add_element_type_stable("Align", beetlemonkey, 119);
  (void) click_add_element_type_stable("AlignmentInfo", beetlemonkey, 120);
  (void) click_add_element_type_stable("AnnotationInfo", beetlemonkey, 121);
  (void) click_add_element_type_stable("AverageCounter", beetlemonkey, 122);
  (void) click_add_element_type_stable("BandwidthMeter", beetlemonkey, 123);
  (void) click_add_element_type_stable("BandwidthShaper", beetlemonkey, 124);
  (void) click_add_element_type_stable("Block", beetlemonkey, 125);
  (void) click_add_element_type_stable("Burster", beetlemonkey, 126);
  (void) click_add_element_type_stable("BandwidthRatedSplitter", beetlemonkey, 127);
  (void) click_add_element_type_stable("BandwidthRatedUnqueue", beetlemonkey, 128);
  (void) click_add_element_type_stable("CheckCRC32", beetlemonkey, 129);
  (void) click_add_element_type_stable("CheckLength", beetlemonkey, 130);
  (void) click_add_element_type_stable("CheckPaint", beetlemonkey, 131);
  (void) click_add_element_type_stable("Classifier", beetlemonkey, 132);
  (void) click_add_element_type_stable("ClickyInfo", beetlemonkey, 133);
  (void) click_add_element_type_stable("CompareBlock", beetlemonkey, 134);
  (void) click_add_element_type_stable("Counter", beetlemonkey, 135);
  (void) click_add_element_type_stable("DelayShaper", beetlemonkey, 136);
  (void) click_add_element_type_stable("DelayUnqueue", beetlemonkey, 137);
  (void) click_add_element_type_stable("DevirtualizeInfo", beetlemonkey, 138);
  (void) click_add_element_type_stable("Discard", beetlemonkey, 139);
  (void) click_add_element_type_stable("DiscardNoFree", beetlemonkey, 140);
  (void) click_add_element_type_stable("DriverManager", beetlemonkey, 141);
  (void) click_add_element_type_stable("DropBroadcasts", beetlemonkey, 142);
  (void) click_add_element_type_stable("DRRSched", beetlemonkey, 143);
  (void) click_add_element_type_stable("ErrorElement", beetlemonkey, 144);
  (void) click_add_element_type_stable("FlowInfo", beetlemonkey, 145);
  (void) click_add_element_type_stable("FrontDropQueue", beetlemonkey, 146);
  (void) click_add_element_type_stable("Queue", beetlemonkey, 147);
  (void) click_add_element_type_stable("FullNoteQueue", beetlemonkey, 148);
  (void) click_add_element_type_stable("HashSwitch", beetlemonkey, 149);
  (void) click_add_element_type_stable("Hub", beetlemonkey, 150);
  (void) click_add_element_type_stable("Idle", beetlemonkey, 151);
  (void) click_add_element_type_stable("InfiniteSource", beetlemonkey, 152);
  ...
  (void) click_add_element_type_stable("Null1", beetlemonkey, 167);
  (void) click_add_element_type_stable("Null2", beetlemonkey, 168);
  (void) click_add_element_type_stable("Null3", beetlemonkey, 169);
  (void) click_add_element_type_stable("Paint", beetlemonkey, 170);
  (void) click_add_element_type_stable("PaintSwitch", beetlemonkey, 171);
  (void) click_add_element_type_stable("PaintTee", beetlemonkey, 172);
  (void) click_add_element_type_stable("PortInfo", beetlemonkey, 173);
  (void) click_add_element_type_stable("Print", beetlemonkey, 174);
  (void) click_add_element_type_stable("PrioSched", beetlemonkey, 175);
  (void) click_add_element_type_stable("PullSwitch", beetlemonkey, 176);
  (void) click_add_element_type_stable("QuickNoteQueue", beetlemonkey, 177);
  (void) click_add_element_type_stable("QuitWatcher", beetlemonkey, 178);
  (void) click_add_element_type_stable("RandomBitErrors", beetlemonkey, 179);
  (void) click_add_element_type_stable("RandomSample", beetlemonkey, 180);
  (void) click_add_element_type_stable("RandomSource", beetlemonkey, 181);
  (void) click_add_element_type_stable("RandomSwitch", beetlemonkey, 182);
  (void) click_add_element_type_stable("RatedSource", beetlemonkey, 183);
  (void) click_add_element_type_stable("RatedSplitter", beetlemonkey, 184);
  (void) click_add_element_type_stable("RatedUnqueue", beetlemonkey, 185);
  (void) click_add_element_type_stable("RoundRobinSched", beetlemonkey, 186);
  (void) click_add_element_type_stable("RoundRobinSwitch", beetlemonkey, 187);
  (void) click_add_element_type_stable("ScheduleInfo", beetlemonkey, 188);
  (void) click_add_element_type_stable("Script", beetlemonkey, 189);
  Script::static_initialize();
  (void) click_add_element_type_stable("SetAnnoByte", beetlemonkey, 190);
  (void) click_add_element_type_stable("SetCRC32", beetlemonkey, 191);
  (void) click_add_element_type_stable("SetPacketType", beetlemonkey, 192);
  (void) click_add_element_type_stable("SetTimestamp", beetlemonkey, 193);
  (void) click_add_element_type_stable("Shaper", beetlemonkey, 194);
  (void) click_add_element_type_stable("SimpleQueue", beetlemonkey, 195);
  (void) click_add_element_type_stable("StaticPullSwitch", beetlemonkey, 196);
  (void) click_add_element_type_stable("StaticSwitch", beetlemonkey, 197);
  (void) click_add_element_type_stable("StoreData", beetlemonkey, 198);
  (void) click_add_element_type_stable("StrideSched", beetlemonkey, 199);
  (void) click_add_element_type_stable("StrideSwitch", beetlemonkey, 200);
  (void) click_add_element_type_stable("Strip", beetlemonkey, 201);
  (void) click_add_element_type_stable("StripToNetworkHeader", beetlemonkey, 202);
  (void) click_add_element_type_stable("Suppressor", beetlemonkey, 203);
  (void) click_add_element_type_stable("Switch", beetlemonkey, 204);
  (void) click_add_element_type_stable("Tee", beetlemonkey, 205);
  (void) click_add_element_type_stable("PullTee", beetlemonkey, 206);
  (void) click_add_element_type_stable("ThreadSafeQueue", beetlemonkey, 207);
  (void) click_add_element_type_stable("TimedSink", beetlemonkey, 208);
  (void) click_add_element_type_stable("TimedSource", beetlemonkey, 209);
  (void) click_add_element_type_stable("TimedUnqueue", beetlemonkey, 210);
  (void) click_add_element_type_stable("Truncate", beetlemonkey, 211);
  (void) click_add_element_type_stable("Unqueue", beetlemonkey, 212);
  (void) click_add_element_type_stable("Unqueue2", beetlemonkey, 213);
  (void) click_add_element_type_stable("Unstrip", beetlemonkey, 214);
  (void) click_add_element_type_stable("CheckTCPHeader", beetlemonkey, 215);
  (void) click_add_element_type_stable("CheckUDPHeader", beetlemonkey, 216);
  (void) click_add_element_type_stable("DynamicUDPIPEncap", beetlemonkey, 217);
  (void) click_add_element_type_stable("IPRewriter", beetlemonkey, 218);
  (void) click_add_element_type_stable("SetTCPChecksum", beetlemonkey, 219);
  (void) click_add_element_type_stable("SetUDPChecksum", beetlemonkey, 220);
  (void) click_add_element_type_stable("TCPFragmenter", beetlemonkey, 221);
  (void) click_add_element_type_stable("TCPIPSend", beetlemonkey, 222);
  (void) click_add_element_type_stable("TCPRewriter", beetlemonkey, 223);
  (void) click_add_element_type_stable("UDPIPEncap", beetlemonkey, 224);
  (void) click_add_element_type_stable("UDPRewriter", beetlemonkey, 225);
  (void) click_add_element_type_stable("BigHashMapTest", beetlemonkey, 226);
  (void) click_add_element_type_stable("BigintTest", beetlemonkey, 227);
  (void) click_add_element_type_stable("BlockThread", beetlemonkey, 228);
  (void) click_add_element_type_stable("CheckPacket", beetlemonkey, 229);
  (void) click_add_element_type_stable("CLPTest", beetlemonkey, 230);
  (void) click_add_element_type_stable("ComparePackets", beetlemonkey, 231);
  (void) click_add_element_type_stable("ConfParseTest", beetlemonkey, 232);
  (void) click_add_element_type_stable("CryptoTest", beetlemonkey, 233);
  (void) click_add_element_type_stable("ErrorTest", beetlemonkey, 234);
  (void) click_add_element_type_stable("FunctionTest", beetlemonkey, 235);
  (void) click_add_element_type_stable("HandlerTask", beetlemonkey, 236);
  (void) click_add_element_type_stable("HashTableTest", beetlemonkey, 237);
  (void) click_add_element_type_stable("HeapTest", beetlemonkey, 238);
  (void) click_add_element_type_stable("ListTest", beetlemonkey, 239);
  (void) click_add_element_type_stable("NeighborhoodTest", beetlemonkey, 240);
  (void) click_add_element_type_stable("NotifierDebug", beetlemonkey, 241);
  (void) click_add_element_type_stable("NullTask", beetlemonkey, 242);
  (void) click_add_element_type_stable("PacketTest", beetlemonkey, 243);
  (void) click_add_element_type_stable("QueueYankTest", beetlemonkey, 244);
  (void) click_add_element_type_stable("RandomSeed", beetlemonkey, 245);
  (void) click_add_element_type_stable("SchedOrderTest", beetlemonkey, 246);
  (void) click_add_element_type_stable("SortTest", beetlemonkey, 247);
  (void) click_add_element_type_stable("TimerTest", beetlemonkey, 248);
  (void) click_add_element_type_stable("TokenBucketTest", beetlemonkey, 249);
  (void) click_add_element_type_stable("UpstreamNotifier", beetlemonkey, 250);
  (void) click_add_element_type_stable("VectorTest", beetlemonkey, 251);
  (void) click_add_element_type_stable("SpinlockAcquire", beetlemonkey, 252);
  (void) click_add_element_type_stable("SpinlockInfo", beetlemonkey, 253);
  (void) click_add_element_type_stable("SpinlockRelease", beetlemonkey, 254);
  (void) click_add_element_type_stable("StaticThreadSched", beetlemonkey, 255);
  (void) click_add_element_type_stable("ChangeUID", beetlemonkey, 256);
  (void) click_add_element_type_stable("ChatterSocket", beetlemonkey, 257);
  (void) click_add_element_type_stable("ControlSocket", beetlemonkey, 258);
  (void) click_add_element_type_stable("FromDevice", beetlemonkey, 259);
  (void) click_add_element_type_stable("FromDump", beetlemonkey, 260);
  (void) click_add_element_type_stable("FromHost", beetlemonkey, 261);
  (void) click_add_element_type_stable("FromRawSocket", beetlemonkey, 262);
  (void) click_add_element_type_stable("FromSocket", beetlemonkey, 263);
  (void) click_add_element_type_stable("KernelFilter", beetlemonkey, 264);
  (void) click_add_element_type_stable("KernelTap", beetlemonkey, 265);
  (void) click_add_element_type_stable("KernelTun", beetlemonkey, 266);
  (void) click_add_element_type_stable("KernelHandlerProxy", beetlemonkey, 267);
  (void) click_add_element_type_stable("ProgressBar", beetlemonkey, 268);
  (void) click_add_element_type_stable("RawSocket", beetlemonkey, 269);
  (void) click_add_element_type_stable("Socket", beetlemonkey, 270);
  (void) click_add_element_type_stable("ToDevice", beetlemonkey, 271);
  (void) click_add_element_type_stable("ToDump", beetlemonkey, 272);
  (void) click_add_element_type_stable("ToHost", beetlemonkey, 273);
  (void) click_add_element_type_stable("ToRawSocket", beetlemonkey, 274);
  (void) click_add_element_type_stable("ToSocket", beetlemonkey, 275);
  (void) click_add_element_type_stable("UMLSwitch", beetlemonkey, 276);
