/* Generated by "click-buildtool elem2export" on Tue Nov  4 17:45:18 CET 2014 */
...
beetlemonkey(uintptr_t heywood)
{
  switch (heywood) {
   ...
   case 110: return new ForeignReplyProcess;
   case 111: return new ForeignRequestProcess;
   case 112: return new HomeRequestProcess;
   case 113: return new MobilityEmulator;
   case 114: return new RegistrationRequestSender;
   case 115: return new VisitorList;
   ...
   case 164: return new Null4;
   case 165: return new Null5;
   case 166: return new Null6;
   case 167: return new Null7;
   case 168: return new Null8;
   case 169: return new Null1;
   case 170: return new Null2;
   case 171: return new Null3;
   case 172: return new Paint;
   case 173: return new PaintSwitch;
   case 174: return new PaintTee;
   case 175: return new PortInfo;
   case 176: return new Print;
   case 177: return new PrioSched;
   case 178: return new PullSwitch;
   case 179: return new QuickNoteQueue;
   case 180: return new QuitWatcher;
   case 181: return new RandomBitErrors;
   case 182: return new RandomSample;
   case 183: return new RandomSource;
   case 184: return new RandomSwitch;
   case 185: return new RatedSource;
   case 186: return new RatedSplitter;
   case 187: return new RatedUnqueue;
   ...
   case 220: return new IPRewriter;
   case 221: return new SetTCPChecksum;
   case 222: return new SetUDPChecksum;
   case 223: return new TCPFragmenter;
   case 224: return new TCPIPSend;
   case 225: return new TCPRewriter;
   case 226: return new UDPIPEncap;
   case 227: return new UDPRewriter;
   case 228: return new BigHashMapTest;
   case 229: return new BigintTest;
   case 230: return new BlockThread;
   case 231: return new CheckPacket;
   case 232: return new CLPTest;
   case 233: return new ComparePackets;
   case 234: return new ConfParseTest;
   case 235: return new CryptoTest;
...
click_export_elements()
{
  ...
  (void) click_add_element_type_stable("ForeignReplyProcess", beetlemonkey, 110);
  (void) click_add_element_type_stable("ForeignRequestProcess", beetlemonkey, 111);
  (void) click_add_element_type_stable("HomeRequestProcess", beetlemonkey, 112);
  (void) click_add_element_type_stable("MobilityEmulator", beetlemonkey, 113);
  (void) click_add_element_type_stable("RegistrationRequestSender", beetlemonkey, 114);
  (void) click_add_element_type_stable("VisitorList", beetlemonkey, 115);
  ...
  (void) click_add_element_type_stable("Null4", beetlemonkey, 164);
  (void) click_add_element_type_stable("Null5", beetlemonkey, 165);
  (void) click_add_element_type_stable("Null6", beetlemonkey, 166);
  (void) click_add_element_type_stable("Null7", beetlemonkey, 167);
  (void) click_add_element_type_stable("Null8", beetlemonkey, 168);
  (void) click_add_element_type_stable("Null1", beetlemonkey, 169);
  (void) click_add_element_type_stable("Null2", beetlemonkey, 170);
  (void) click_add_element_type_stable("Null3", beetlemonkey, 171);
  ...
  (void) click_add_element_type_stable("PortInfo", beetlemonkey, 175);
  (void) click_add_element_type_stable("Print", beetlemonkey, 176);
  (void) click_add_element_type_stable("PrioSched", beetlemonkey, 177);
  (void) click_add_element_type_stable("PullSwitch", beetlemonkey, 178);
  (void) click_add_element_type_stable("QuickNoteQueue", beetlemonkey, 179);
  (void) click_add_element_type_stable("QuitWatcher", beetlemonkey, 180);
  (void) click_add_element_type_stable("RandomBitErrors", beetlemonkey, 181);
  (void) click_add_element_type_stable("RandomSample", beetlemonkey, 182);
  (void) click_add_element_type_stable("RandomSource", beetlemonkey, 183);
  (void) click_add_element_type_stable("RandomSwitch", beetlemonkey, 184);
  (void) click_add_element_type_stable("RatedSource", beetlemonkey, 185);
  (void) click_add_element_type_stable("RatedSplitter", beetlemonkey, 186);
  (void) click_add_element_type_stable("RatedUnqueue", beetlemonkey, 187);
  ...
  (void) click_add_element_type_stable("IPRewriter", beetlemonkey, 220);
  (void) click_add_element_type_stable("SetTCPChecksum", beetlemonkey, 221);
  (void) click_add_element_type_stable("SetUDPChecksum", beetlemonkey, 222);
  (void) click_add_element_type_stable("TCPFragmenter", beetlemonkey, 223);
  (void) click_add_element_type_stable("TCPIPSend", beetlemonkey, 224);
  (void) click_add_element_type_stable("TCPRewriter", beetlemonkey, 225);
  (void) click_add_element_type_stable("UDPIPEncap", beetlemonkey, 226);
  (void) click_add_element_type_stable("UDPRewriter", beetlemonkey, 227);
  (void) click_add_element_type_stable("BigHashMapTest", beetlemonkey, 228);
  (void) click_add_element_type_stable("BigintTest", beetlemonkey, 229);
  (void) click_add_element_type_stable("BlockThread", beetlemonkey, 230);
  (void) click_add_element_type_stable("CheckPacket", beetlemonkey, 231);
  (void) click_add_element_type_stable("CLPTest", beetlemonkey, 232);
  (void) click_add_element_type_stable("ComparePackets", beetlemonkey, 233);
  (void) click_add_element_type_stable("ConfParseTest", beetlemonkey, 234);
  (void) click_add_element_type_stable("CryptoTest", beetlemonkey, 235);
